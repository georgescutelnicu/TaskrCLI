import calendar
import datetime
from task_manager import handle_task_management
...
def display_calendar(year, month):
    ...
    legend_lines = [
        ...
        "\033[1;32mGreen\033[0m - Task Completed",
        "\033[1;31mRed\033[0m - Task Pending"
    ]

    print()
    for i in range(len(calendar_lines)):
        legend_line = legend_lines[i] if i < len(legend_lines) else ""
        print(f"{calendar_lines[i].ljust(30)} {legend_line}")
